...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if rank in [-1, 0]:
        ...
        if not opt.resume:
            ...
            if plots:
                plot_labels(labels, names=names, save_dir=save_dir, loggers=loggers)
                if tb_writer:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/shw/code/yolov5-new/yolov5/runs/train/exp86/_6/pruned_yolov5s.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/home/shw/code/yolov5-new/yolov5/runs/train/exp86/_6/pruned_yolov5s.yaml', help='model.yaml path')
