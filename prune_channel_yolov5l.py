...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp60/weights/last_150.pt', help='initial weights path')
    parser.add_argument('--device', default='3', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--batch-size', type=int, default=8, help="Total batch size for all gpus.")
    parser.add_argument("--overall_ratio", default=0.8, type=float, help='pruning rate')
    parser.add_argument("--perlayer_ratio", default=0.1, type=float, help='pruning protection rate')
    parser.add_argument("--save", default='/home/shw/code/yolov5-new/yolov5/runs/train/exp60', type=str, help='path to save pruned model (default: none)')
