...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/shw/code/yolov5-new/yolov5/runs/train/exp86/weights/last_90.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov5s_trs.yaml', help='model.yaml path')
